...
function commandTypeChanged() {
    ...
    getElementById("cmd_generator_ign_header").style.display = getElementById("player_name").style.display = commandType.value.toLowerCase() === commandType["5"].value.toLowerCase() ? "hidden" : "visible";
}
