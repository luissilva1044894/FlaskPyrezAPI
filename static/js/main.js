...
function commandTypeChanged() {
    ...
    getElementById("cmd_generator_ign_header").style.visibility = commandType.value.toLowerCase() === commandType["6"].value.toLowerCase() ? "hidden" : "visible";
    getElementById("player_name").style.visibility = commandType.value.toLowerCase() === commandType["6"].value.toLowerCase() ? "hidden" : "visible";
}
