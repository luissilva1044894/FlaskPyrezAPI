...
function addCommandOutput(codeMsgChat, codeMsgBackend, botName, lang="en") {
    ...
    divMsg += "<div><button onclick=\"copyToClipboard()\" class=\"nav-link waves-effect\" data-clipboard-action=\"copy\" data-clipboard-target=\"code-chat-bot\" aria-label=\"Copy to clipboard\" data-original-label=\"Copy to clipboard\"><i class=\"fa fa-copy\" style=\"font-size:24px\" aria-hidden=\"true\"></i></button></div>"
